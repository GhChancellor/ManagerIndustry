 ...
 * @author lele
 */
public class NameBase_OLD extends ItemRecursion {
    private int typeID;
     ...
     */
    public NameBase_OLD(int typeID, String typeName) {
        this.typeID = typeID;
     ...
     * @param int quanityI 
     */
    public NameBase_OLD(int typeID, int quanityInt) {
        this.typeID = typeID;
     ...
     * @param int quanityI 
     */
    public NameBase_OLD(int typeID, String name, int quanityInt) {
        this.typeID = typeID;
        this.typeName = name;
        this.quanityI = quanityInt;
    }
     ...
     */
    public NameBase_OLD(int typeID, int quanityI, double quanityD) {
        this.typeID = typeID;
     ...
     * @param double quanityD 
     */
    public NameBase_OLD(int typeID, String name, int quanityInt, double quanityDbl) {
        this.typeID = typeID;
        this.typeName = name;
        this.quanityI = quanityInt;
