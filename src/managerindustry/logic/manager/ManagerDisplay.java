    ...
    private void baseMaterial(String bpoName){     
        ...
        if ( ! nameItemToBuild.isEmpty() ){
            for (IndustryActivityMaterials invTypeMaterialse :  nameItemToBuild) {
                InvTypes invTypes = 
                  ManagerDB.getInstance().invTypes().getNameById(invTypeMaterialse.getMaterialTypeID());
                ...
                if ( neededComponents != null){                    
                    for (IndustryActivityMaterials neededComponent : neededComponents) { 
                        ...
                        invTypes = ManagerDB.getInstance().invTypes().getNameById(neededComponent.getMaterialTypeID());
...
//        }
    ...
    public void getSolarSystemID(){
        InvNames invNames = ManagerDB.getInstance().invNames().getSolarSystemID("Jita");
