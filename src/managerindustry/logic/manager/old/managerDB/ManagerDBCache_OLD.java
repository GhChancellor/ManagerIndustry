 ...
 * @author lele
 */
public class ManagerDBCache_OLD {
    private static ManagerDBCache_OLD instance = null;
    ...
    public static ManagerDBCache_OLD getInstance(){
        if ( instance == null )
            instance = new ManagerDBCache_OLD();
        return instance;
    }
