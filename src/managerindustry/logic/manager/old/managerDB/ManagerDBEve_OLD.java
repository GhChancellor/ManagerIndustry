 ...
 * @author lele
 */
public class ManagerDBEve_OLD {
    private static ManagerDBEve_OLD instance = null;
    private EntityManager entityManager = Persistence.createEntityManagerFactory("ManagerIndustryPU").createEntityManager();
        
    public static ManagerDBEve_OLD getInstance (){
        if ( instance == null ){
            instance = new ManagerDBEve_OLD();
        }
        return instance;
    }    
...
//    }
     ...
     */
    public SkillX getInvTypes_SkillValues(int typeID, Boolean published, int attributeID){
        try {
            ...
            TypedQuery < SkillX > typedQueryTQ = 
              getInvTypeGroupAndNameEM.createNamedQuery("InvTypes.findByTypeId-Published-AttributeID", SkillX.class);
...
////         Convert name to Id
        ...
        List < IndustryActivityMaterials > invTypeMaterialses  = ManagerDBEve_OLD.getInstance().getIndustryActivityMaterialsID( invTypes.getTypeID() );
    ...
    public DgmTypeAttributes getItemDescription(String bpoName, int attributeID){
        ...
        */
        ...
        DgmTypeAttributes  dgmTypeAttributes = 
         ManagerDBEve_OLD.getInstance().getValueStation(invTypes.getTypeID(), attributeID );
...
//    --------------------------------------------------------------------
    ...
    public List < IndustryActivityMaterials > getMaterialNeedById( IndustryActivityMaterials industryActivityMaterials){
        ...
        InvTypes invTypes = ManagerDBEve_OLD.getInstance().getInvTypes_NameById(industryActivityMaterials.getMaterialTypeID());
