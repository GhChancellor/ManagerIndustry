...
//            MaterialEfficiencyCalculate materialEfficiencyCalculate = new 
//           MaterialEfficiencyCalculate(run, job, bpoME , componentX.getQuanityInt() );
//            
...
//            ReportCalculatedComponentX totalCalculatedComponentX = 
...
//            ManagerComponentX.getInstance().sumReportCalculatedComponentXMap(totalCalculatedComponentX);
//            
...
//                
//                String xxxx = materialForComponent.getName();
//                // value of the single item
...
//                
//                // Put Total Calculated Components
//                totalCalculatedComponentX = new ReportCalculatedComponentX(materialForComponent.getName(), secondStepTotalMaterials );
//                
//                // Put single Calculated Component
...
//                
//                // add value of the single item to map
//                // fa casino meglio una lista ricorsiva
//                ManagerComponentX.getInstance().addSingleCalculatedComponentXMap(singleCalculatedComponentX);
//
