 ...
 * @deprecated 
 */
public class ManagerBuild_OLD {
   
    public ManagerBuild_OLD(String bpoName, int run, int job, int bpoME, 
        int componentMe) {
        ...
        List< IndustryActivityMaterials> nameItemToBuild = 
         ManagerDBEve_OLD.getInstance().getMaterialNeedByName(bpoName);        
