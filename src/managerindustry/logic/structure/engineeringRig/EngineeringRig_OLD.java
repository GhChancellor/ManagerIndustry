...
import managerindustry.logic.structure.engineeringRig.invMarketGroup.rig.fakeRig.FakeRig;
 ...
 * @author lele
 */
public class EngineeringRig_OLD {
...
//    private String nameRig;
     ...
     */
    public EngineeringRig_OLD(String nameRig, SecurityStatusEnum securityStatusEnum){
        InvTypes invTypes = ManagerDB.getInstance().invTypes().getInvTypesByName(nameRig);
        typeID = invTypes.getTypeID();
               
        List < DgmTypeAttributes > dgmTypeAttributes = ManagerDB.getInstance().dgmTypeAttributes().getTypeAttributesByTypeId(typeID);
     ...
     * @param SecurityStatusEnum securityStatusEnum 
     */
    public EngineeringRig_OLD(TierEnum tier, RuleBonusRigEnum materialTimeCostBonus, SecurityStatusEnum securityStatusEnum) {
        initDbBackUp();
