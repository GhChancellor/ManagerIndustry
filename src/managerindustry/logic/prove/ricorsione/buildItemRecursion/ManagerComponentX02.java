 ...
 * @author lele
 */
public class ManagerComponentX02 {
    private static ManagerComponentX02 instance = null;
    private List < ComponentX02> baseComponentXs = new ArrayList<>();
...
//    private Map < String, SingleCalculatedComponentX > singleCalculatedComponentXMap = new HashMap<>();
    ...
    public static ManagerComponentX02 getInstance(){
        if ( instance == null ){
            instance = new ManagerComponentX02();
        }
        return instance;
    }
     ...
     */
    public List<ComponentX02> getBaseComponentXs() {
     ...
     */
    public void setBaseComponentXs(List<ComponentX02> baseComponentXs) {
     ...
     */
    public void addComponentXs(ComponentX02 componentX) {
