...
public class RigLarge extends RigSize{
    ...
    public List<InvTypes> getStandupLSetAdvancedLargeShipManufacturing(){
        ...
        rigGroups.add(37169); // Standup L-Set Advanced Large Ship Manufacturing Efficiency II
        return getInvTypes(rigGroups);
    }  
    ...
    public List<InvTypes> getStandupLSetEquipmentManufacturing(){
        ...
        rigGroups.add(37171); // Standup L-Set Equipment Manufacturing Efficiency II
        return getInvTypes(rigGroups);
    }  
    ...
    public List<InvTypes> getStandupLSetCapitalShipManufacturing(){
        ...
        rigGroups.add(37173); // Standup L-Set Capital Ship Manufacturing Efficiency I
        return getInvTypes(rigGroups);
    }  
    ...
    public List<InvTypes> getStandupLSetAdvancedComponentManufacturing(){
        ...
        rigGroups.add(37175); // Standup L-Set Advanced Component Manufacturing Efficiency II
        return getInvTypes(rigGroups);
    }  
    ...
    public List<InvTypes> getStandupLSetAdvancedSmallShipManufacturing(){
        ...
        rigGroups.add(43708); // Standup L-Set Advanced Small Ship Manufacturing Efficiency II
        return getInvTypes(rigGroups);
    }  
    ...
    public List<InvTypes> getStandupLSetAdvancedMediumShipManufacturing(){
        ...
        rigGroups.add(43711); // Standup L-Set Advanced Medium Ship Manufacturing Efficiency II
        return getInvTypes(rigGroups);
    }  
    ...
    public List<InvTypes> getStandupLSetBasicSmallShipManufacturing(){
        ...
        rigGroups.add(43715); // Standup L-Set Basic Small Ship Manufacturing Efficiency II
        return getInvTypes(rigGroups);
    }  
    ...
    public List<InvTypes> getStandupLSetBasicMediumShipManufacturing(){
        ...
        rigGroups.add(43717); // Standup L-Set Basic Medium Ship Manufacturing Efficiency II
        return getInvTypes(rigGroups);
    }  
    ...
    public List<InvTypes> getStandupLSetBasicCapitalComponentManufacturing(){
        ...
        rigGroups.add(43719); // Standup L-Set Basic Capital Component Manufacturing Efficiency II
        return getInvTypes(rigGroups);
    }  
    ...
    public List<InvTypes> getStandupLSetStructureManufacturing(){
        ...
        rigGroups.add(43721); // Standup L-Set Structure Manufacturing Efficiency II
        return getInvTypes(rigGroups);
    }  
    ...
    public List<InvTypes> getStandupLSetInvention(){
        ...
        rigGroups.add(43723); // Standup L-Set Invention Optimization II
        return getInvTypes(rigGroups);
    }  
    ...
    public List<InvTypes> getStandupLSetMEResearch(){
        ...
        rigGroups.add(43725); // Standup L-Set ME Research Optimization II
        return getInvTypes(rigGroups);
    }  
    ...
    public List<InvTypes> getStandupLSetTEResearch(){
        ...
        rigGroups.add(43727); // Standup L-Set TE Research Optimization II
        return getInvTypes(rigGroups);
    }  
    ...
    public List<InvTypes> getStandupLSetBlueprintCopy(){
        ...
        rigGroups.add(43730); // Standup L-Set Blueprint Copy Optimization II
        return getInvTypes(rigGroups);
    }  
    ...
    public List<InvTypes> getStandupLSetThukkerBasicCapitalComponentManufacturing(){
        ...
        rigGroups.add(45641); // Standup L-Set Thukker Advanced Component Manufacturing Efficiency
        return getInvTypes(rigGroups);
    }  
