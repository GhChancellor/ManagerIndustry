 ...
 * @author lele
 */
public class BuildItem_OLD extends GenericRequiredItem{
     ...
     */
    public BuildItem_OLD(String bpoName, int run, int job, byte bpoME, byte componentMe, 
...
//        reportItem.addItem(singleItem);
    ...
    @Override
    protected void requiredItem(Object RequiredMaterialRecusion_) {
        BasicMaterialRequired nameRequiredMaterialRecusion_ = (BasicMaterialRequired ) RequiredMaterialRecusion_;
         
        List<RequiredMaterialRecusion> basicMaterialList = nameRequiredMaterialRecusion_.getBasicMaterialList();
        
        for (RequiredMaterialRecusion materialRecusion : basicMaterialList) {
...
//            ( List<BasicMaterialRequired> ) materialRecusion_.;
//        
...
//        
    ...
    public void display(){
//        GenericRequiredItem.display(this);
