 ...
 * @author lele
 */
public abstract class GenericRequiredItemORI  < T >{
    ...
    public void basicMaterialToListDBG
        (RequiredMaterialRecusion materialRecusion_, Converter converter ){
        ...
        for (ItemRecursionB requiredItem : requiredItemA.getRecursionB02s()) {
            basicMaterialToListDBG((RequiredMaterialRecusion) requiredItem.getRecursionA02(), converter);
        }
    }   
}
