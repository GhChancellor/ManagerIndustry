...
//        }
    ...
    public void rigRucursion(){
        ...
        List<RigMarketGroupRecursion> rigMarketGroupsList = rigRecusion.getRigMarketGroupsList();
        
        for (RigMarketGroupRecursion rigMarketGroupRecursion : rigMarketGroupsList) {
            System.out.println("" + rigMarketGroupRecursion.getMarketGroupName());
        }
//        setDublicate();
