...
@NamedQuery(name = "TaxSolarSystemEntity.getSolarSystem", query = "SELECT a FROM TaxSolarSystemEntity a WHERE a.solarSystemID = :solarSystemID"),
...
//    }    
    ...
    public String toString() {
        return "managerindustry.db.entities.TaxSolarSystemEntity[ id=" + id + " ]";
    }
